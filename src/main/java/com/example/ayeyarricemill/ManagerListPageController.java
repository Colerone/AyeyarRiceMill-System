...
public class ManagerListPageController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try{
            ...
            Parent contentArea = FXMLLoader.load(getClass().getResource("/com/example/ayeyarricemill/ManagerList.fxml"));

            BorderPane innerPane = new BorderPane();
//            SceneController.setBorderPane(borderPane);
