...
public class ProjectInfoPageController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try{
            ...
            Parent contentArea = FXMLLoader.load(getClass().getResource("/com/example/ayeyarricemill/projectInfo.fxml"));
